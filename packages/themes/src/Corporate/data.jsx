...
import background from './assets/header-photo.png';
...
export default {
  ...
  welcome: {
    ...
    title: 'Mai Te Pora',
    subtitle: 'We move forward together',
    description:
      'MTP is a group of developers and early supporters committed to growing the Switcheo Ecosystem.',
    actions: [
      {
        as: 'a',
        href:
